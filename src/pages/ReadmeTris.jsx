...
function ReadmeTris() {
  return (
    <ReadmeWindow title="Tic Tac Toe – Web App"
    ...
    >
      ...
      <h2 className="text-xl sm:text-xl  text-white">
        ...
        Tris, sviluppata in HTML, CSS e JavaScript. È il mio  primo
        progetto di programmazione, realizzato durante le scuole superiori, con
        un’interfaccia volutamente essenziale e basata su tecnologie web di
        base.
      </h2>
      <hr />
      {/* Obiettivo */}
      ...
      <p className="text-neutral-300">
        Creare un gioco completamente funzionante da browser, con logica di
        gioco completa, gestione dei turni, rilevamento automatico di
        vittoria/pareggio e un sistema di match che rende l’esperienza più
        coinvolgente.
      </p>
      <hr />
      {/* Stack Tecnologico */}
      ...
      <div className="flex flex-wrap items-center gap-6 mt-4">
        ...
        <div className="flex flex-col items-center">
          <i className="devicon-chartjs-plain colored text-5xl"></i>
      ...
      <p className="text-neutral-300">
        Il gioco gestisce turni alternati tra X e O, controlla automaticamente
        le condizioni di vittoria e pareggio e permette di resettare la board in
