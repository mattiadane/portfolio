...
function ReadmeDiabetic() {
  return (
    <ReadmeWindow title="Diabetic System — Applicativo per la gestione del percorso diabetologico"
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-6 mt-6">
        ...
        {/* JUnit */}
        <div className="flex flex-col items-center">
          <i className="devicon-junit-plain colored text-5xl"></i>
      ...
      <h4 className="text-lg font-semibold text-white">Diabetologo</h4>
